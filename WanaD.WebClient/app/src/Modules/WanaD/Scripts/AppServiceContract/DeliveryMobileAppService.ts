 ...
 import { FsAjaxSettings } from "../../../../Lib/Fs.Core.Aurelia/Components/FsAjaxSettings";
    ...
    import DeliveryRequest from 'Modules/WanaD/Scripts/AppServiceContract/DeliveryRequest';


    //module DeliveryMobileAppService {
    

    class DeliveryMobileAppService {
    ...
    constructor(serverBaseUrl : string = null, controllerPath : string = null, ajaxOptions : FsAjaxSettings = null){
        this.ControllerUrl = ((serverBaseUrl == null || serverBaseUrl == "") ? fs.Config.ServiceBaseUrl : serverBaseUrl) + ((controllerPath == null || controllerPath == "") ?  "modules/WanaD.AppService/DeliveryMobileAppService" : controllerPath);
        this.Options = ajaxOptions;
    }

    public Init(options : any = { serverBaseUrl :  null, controllerPath : null, ajaxOptions : null }){
        this.ControllerUrl = ((options.serverBaseUrl == null) ? fs.Config.ServiceBaseUrl : options.serverBaseUrl) + ((options.controllerPath == null) ?  "modules/WanaD.AppService/DeliveryMobileAppService" : options.controllerPath);
    ...
    // post: api/${controller}/
    //public static RouteFindAsync = () => this.ServiceUrl + `modules/WanaD.AppServiceContract/DeliveryMobileAppService/FindAsync`;
    ...
    // post: api/${controller}/
    //public static RouteCount = () => this.ServiceUrl + `modules/WanaD.AppServiceContract/DeliveryMobileAppService/Count`;
    ...
    //public static RouteLoadAsync = (id: string) => this.ServiceUrl + `modules/WanaD.AppServiceContract/DeliveryMobileAppService/LoadAsync`;
    ...
    // post: api/${controller}/
    //public static RouteFindListPlotAsync = () => this.ServiceUrl + `modules/WanaD.AppServiceContract/DeliveryMobileAppService/FindListPlotAsync`;
    ...
    // post: api/${controller}/
    //public static RouteFindListTeaTypeAsync = () => this.ServiceUrl + `modules/WanaD.AppServiceContract/DeliveryMobileAppService/FindListTeaTypeAsync`;
    ...
    // post: api/${controller}/
    //public static RouteAddAsync = () => this.ServiceUrl + `modules/WanaD.AppServiceContract/DeliveryMobileAppService/AddAsync`;
    public RouteAddAsync() : string {
        return this.ControllerUrl + "/"+"AddAsync";
    }
    public AddAsync(request: DeliveryRequest): JQuery.jqXHR<void> {
        return $.ajax({
    ...
    //public static RouteScanQr = (qrId: string) => this.ServiceUrl + `modules/WanaD.AppServiceContract/DeliveryMobileAppService/ScanQr`;
    public RouteScanQr(qrId: string) : string {
        return this.ControllerUrl + "/"+"ScanQr";
    }
    public ScanQr(qrId: string): JQuery.jqXHR<ProductData> {
        return $.ajax({
    ...
    // post: api/${controller}/
    //public static RouteUpdateAsync = () => this.ServiceUrl + `modules/WanaD.AppServiceContract/DeliveryMobileAppService/UpdateAsync`;
...
export default DeliveryMobileAppService;
