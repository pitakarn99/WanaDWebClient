...
import ManageEvaluateBiodiversityContractSearchVM from "./ManageEvaluateBiodiversityContractSearchVM";


export default class ManageEvaluateBiodiversityContractEditorVM extends EditorVMBase {
    ...
    PlotItem: any;
    Parent: ManageEvaluateBiodiversityContractSearchVM;
    Farm: any;
    ...
    async LoadOriginalSourceAsync(originalSource: BiodiversityContractData) {
        ...
        this.PlotScore = originalSource.PlotScore;
        this.PaymentRequestNo = originalSource.PaymentRequestNo;
    ...
    async SaveOriginalSourceAsync(originalSource: BiodiversityContractData) {
        ...
        originalSource.PlotScore = this.PlotScore;
        originalSource.PaymentRequestNo = this.PaymentRequestNo;
