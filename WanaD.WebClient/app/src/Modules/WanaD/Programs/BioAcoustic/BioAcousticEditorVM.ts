...
import BioAcousticSearchVM from "./BioAcousticSearchVM";
...
export default class BioAcousticEditorVM extends EditorVMBase {
    Id: string;
    ...
    Date: Date;
    SenserId: string;
    SenserCoordinates: string;
    Remark: string;


    Parent: BioAcousticSearchVM;
    constructor() {
        super();
    }

    async LoadOriginalSourceAsync(originalSource: BioAcousticData) {
        ...
        this.SenserId = originalSource.SenserId;
        this.SenserCoordinates = originalSource.SenserCoordinates;
        this.Remark = originalSource.Remark;

    }
    async SaveOriginalSourceAsync(originalSource: BioAcousticData) {
        ...
        originalSource.SenserId = this.SenserId;
        originalSource.SenserCoordinates = this.SenserCoordinates;
